...
a += " <group name=\"advanced\" >\n";
a += "  <option key=\"cursor_blinks\" value=\"true\" />\n";
a += "  <option key=\"word_wrap\" value=\"true\" />\n";
a += " </group>\n";
a += " <group name=\"appearance\" >\n";
a += "  <option key=\"background_color\" value=\"#55aaff\" />\n";
...
a += "  <option key=\"latex\" value=\"bangtex.txt\" />\n";
a += "  <option key=\"lekhorc\" value=\".lekhorc\" />\n";
...
a = "a	1	0985\n";
a += "a^	2	0985 0981\n";
a += "A^	5	0985 09cd 09af 0981 09be\n";
a += "aa	1	0986\n";
a += "aa^	2	0986 0981\n";
a += "a^a	2	0986 0981\n";
a += "A	4	0985 09cd 09af 09be\n";
a += "i	1	0987\n";
a += "I	1	0988\n";
a += "u	1	0989\n";
a += "U	1	098a\n";
...
a += "4	09a4	09cd	09b0	09c1	3	5f	bb	a6\n";
