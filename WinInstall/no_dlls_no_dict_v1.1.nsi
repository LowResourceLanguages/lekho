; no_dlls_no_dict_v1.1.nsi
;
; This script is based on example1.nsi, but adds uninstall support
; and (optionally) start menu shortcuts.
;
; This creates no_dlls_no_dict_v1.1.exe
; It has
; the executable and the fonts, 
; you need a lot more...
; 

; The name of the installer
Name "Lekho v1.1 - barebones"

; The file to write
OutFile "no_dlls_no_dict_v1.1.exe"
...
ComponentText "This will install lekho on your computer. This is the barebones install. Click on a component to deselect/select it. If you have never installed lekho before, consider using full_install_v1.1.exe."
