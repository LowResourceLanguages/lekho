...
Name "Lekho v1.1 - no dlls"

; The file to write
OutFile "no_dlls_v1.1.exe"
...
ComponentText "This will install lekho on your computer. No dlls are provided. Click on a component to deselect/select it. If you have never installed lekho before, just keep the default selection."
